      ...
      <div className="flex justify-between items-center h-20">
        ...
        >
          <div className="relative">
            {/* Custom Logo: Search + Brain + Cart Composite */}
            <div className="w-10 h-10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
              <svg className="w-10 h-10" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 30H30L38 70H75L85 30" stroke="url(#logo_grad)" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="42" cy="82" r="6" fill="#6366f1"/>
                <circle cx="70" cy="82" r="6" fill="#6366f1"/>
                <circle cx="55" cy="45" r="20" stroke="#a5b4fc" strokeWidth="6" className="group-hover:stroke-indigo-500 transition-colors duration-300"/>
                <path d="M70 60L85 75" stroke="#a5b4fc" strokeWidth="8" strokeLinecap="round" className="group-hover:stroke-indigo-500 transition-colors duration-300"/>
                <path d="M48 45C48 45 50 35 55 35C60 35 62 45 62 45" stroke="#ec4899" strokeWidth="4" strokeLinecap="round"/>
                <path d="M45 50H65" stroke="#ec4899" strokeWidth="4" strokeLinecap="round" strokeOpacity="0.8"/>
                <defs>
                  <linearGradient id="logo_grad" x1="20" y1="30" x2="85" y2="70" gradientUnits="userSpaceOnUse">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="/shopify" onClick={(e) => { e.preventDefault(); onNavigate('shopify'); }} className="text-base font-medium text-slate-600 hover:text-indigo-600 transition-colors">Shopify</a>
          <a href="/etsy" onClick={(e) => { e.preventDefault(); onNavigate('etsy'); }} className="text-base font-medium text-slate-600 hover:text-indigo-600 transition-colors">Etsy</a>
          <a href="/amazon" onClick={(e) => { e.preventDefault(); onNavigate('amazon'); }} className="text-base font-medium text-slate-600 hover:text-indigo-600 transition-colors">Amazon</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    ...
                    <div key={i} className="group p-8 rounded-2xl bg-white border border-slate-100 hover:shadow-xl hover:shadow-indigo-100/30 hover:-translate-y-1 transition-all duration-300">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[450px] sm:h-[500px] w-full perspective-1000 mt-16 lg:mt-0 mx-auto max-w-[500px] lg:max-w-none scale-[0.85] sm:scale-100 origin-center lg:origin-right transform-gpu">
                {/* Back Card (Input) */}
                <div className="absolute top-0 left-4 sm:top-10 sm:left-10 w-64 sm:w-72 bg-white p-4 rounded-2xl shadow-2xl border border-slate-200 transform rotate-[-6deg] z-10 transition-transform hover:rotate-0 duration-500 will-change-transform">
                ...
                {/* Front Card (Output) */}
                <div className="absolute bottom-0 right-4 sm:top-20 sm:right-10 w-72 sm:w-80 bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-[0_20px_50px_rgba(79,70,229,0.15)] border border-indigo-100/50 transform rotate-[6deg] z-30 transition-transform hover:rotate-0 duration-500 will-change-transform">
          ...
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 flex items-center justify-center text-white">
                ...
                <svg className="w-8 h-8" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 30H30L38 70H75L85 30" stroke="white" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="42" cy="82" r="6" fill="white"/>
                    <circle cx="70" cy="82" r="6" fill="white"/>
                    <circle cx="55" cy="45" r="20" stroke="white" strokeWidth="6"/>
                </svg>
            </div>
...
const ContentPage = memo(({ title, content, image, onBack, onCtaClick }: { title: string, content: React.ReactNode, image?: string, onBack: () => void, onCtaClick?: () => void }) => (
  <article className="pt-24 min-h-screen bg-white">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10 pb-20">
      <div className="bg-white rounded-2xl p-8 md:p-12 border border-slate-100 shadow-xl shadow-slate-200/50 animate-fade-in-up">
        ...
        {/* CTA Box */}
        <div className="mt-16">
            <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl p-8 md:p-10 text-center text-white shadow-2xl shadow-indigo-500/30">
...
const App: React.FC = () => {
  ...
  const handleDownloadCSV = useCallback(() => {
    ...
    const rows = results.images.map(img => ({
      Filename: img.input_filename,
      SEO_Filename: img.seo.seo_filename,
      Alt_Text: img.seo.alt_text,
      Title: img.seo.title,
      Description: img.seo.description,
      Tags: img.seo.tags?.join(', '),
      Category: img.detected?.category,
      Material: img.detected?.material,
      Shopify_Handle: img.shopify?.handle,
      Etsy_Title: img.etsy?.seo_title,
      Amazon_Keywords: img.amazon?.search_terms_keywords?.join(' ')
    }));
    ...
    link.download = `pixora-seo-batch-${Date.now()}.csv`;
    link.click();
  }, [results]);
  ...
  const renderContent = () => {
    switch (currentView) {
            ...
            <>
                ...
                <div className="space-y-16 mt-12">
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        <div className="w-16 h-16 bg-indigo-100 text-indigo-600 rounded-2xl flex items-center justify-center flex-shrink-0 text-2xl font-bold border border-indigo-200 shadow-sm">1</div>
                        <div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                         <div className="w-16 h-16 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center flex-shrink-0 text-2xl font-bold border border-purple-200 shadow-sm">2</div>
                        <div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                         <div className="w-16 h-16 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center flex-shrink-0 text-2xl font-bold border border-blue-200 shadow-sm">3</div>
                        <div>
                     ...
                     <div className="flex flex-col md:flex-row gap-8 items-start">
                         <div className="w-16 h-16 bg-emerald-100 text-emerald-600 rounded-2xl flex items-center justify-center flex-shrink-0 text-2xl font-bold border border-emerald-200 shadow-sm">4</div>
                        <div>
      ...
      case 'amazon':
        return <ContentPage 
          title="Amazon A9 Algorithm Secrets" 
            ...
            <div className="space-y-12">
              ...
              <div className="grid gap-10">
                {BLOG_POSTS.map(post => (
                  <article 
                    key={post.id} 
                    className="group grid grid-cols-1 md:grid-cols-3 gap-6 cursor-pointer"
          ...
          content={
            <>
               <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-lg hover:shadow-xl transition-shadow">
      ...
      case 'terms':
      case 'cookie':
         return <ContentPage title={currentView.charAt(0).toUpperCase() + currentView.slice(1)} onBack={() => handleNavigate('home')} content={<div className="min-h-[40vh] flex items-center justify-center text-slate-500">Content placeholder for {currentView}. Legal text would go here.</div>} />;
        ...
        return (
          <>
            ...
            <main className={`flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-20 ${!results ? '-mt-24 sm:-mt-32' : 'mt-24'}`}>
              ...
              {!results && (
                <div id="upload-section" className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white p-6 md:p-10 animate-fade-in-up ring-1 ring-slate-900/5 scroll-mt-32">
                  <div className="mb-8 text-center">
                    <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Upload Your Product Images</h2>
                    <p className="text-slate-500 mt-2">Supports JPG, PNG, WEBP • Max 10MB per file</p>
                  </div>
              ...
              {results && (
                <div className="space-y-8"> 
                   <div className="flex flex-wrap gap-4 justify-between items-center bg-white p-6 rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100">
                      ...
                      <div className="flex gap-4">
                        ...
                        <button 
                          ...
                          className="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white rounded-xl text-sm font-bold hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200"
                        >
